...
const PhoneIcon = () => (
  ...
  >
    <path
      d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.3 2 2 0 0 1 3.6 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.6a16 16 0 0 0 6.29 6.29l.96-.96a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"
      strokeWidth="2"
    />
  </svg>
);
...
const SubmissionCard = ({ item, type }) => {
  ...
  const displayComment = isEnquiry
    ? item.comments || null
    : item.message || null;
    ...
    >
      <div className="px-5 py-4 flex items-start gap-4">
        <div
          ...
          style={{
            background: isEnquiry ? "#fde8e3" : "#fef3e2",
            color: accentColor,
          }}
        >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div
            className="mt-1.5 flex flex-wrap gap-x-4 gap-y-0.5 text-sm"
            style={{ color: "#8a4a34" }}
          >
            {displayEmail && (
          ...
          {!expanded && displayService && (
            <p
              className="mt-2 text-sm line-clamp-1 flex items-center gap-1.5"
              style={{ color: "#b45a3a" }}
            >
              <BriefcaseIcon />
              {displayService}
    ...
    <div className="flex items-center justify-center gap-1.5 mt-6 flex-wrap">
      ...
      {pages[0] > 1 && (
        <>
          ...
          {pages[0] > 2 && (
            <span style={{ color: "#d0a090" }} className="px-1">
              …
            </span>
          )}
        </>
...
export default function Dashboard() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      const items =
        (activeTab === "enquiry" ? res.enquiries : res.contacts) || [];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                style={
                  activeTab === tab
                    ? {
                        background: "#f13c20",
                        color: "#fff",
                        boxShadow: "0 2px 10px rgba(241,60,32,0.25)",
                      }
                    : { color: "#b45a3a" }
                }
              >
          ...
          {!loading && (
            ...
            >
              <span
                ...
                style={{
                  background: activeTab === "enquiry" ? "#f13c20" : "#e8a000",
                }}
              />
              <span>
                <span className="font-bold" style={{ color: "#2d1308" }}>
                  {data.total}
                </span>{" "}
                total records
              </span>
        ...
        <div
          ...
          style={{
            background: "#fff",
            border: "1.5px solid #f0d5cc",
            boxShadow: "0 1px 8px rgba(241,60,32,0.06)",
          }}
        >
        ...
        {loading ? (
          ...
          <div
            className={`space-y-2.5 transition-opacity duration-200 ${searching ? "opacity-50 pointer-events-none" : "opacity-100"}`}
          >
            {data.items.map((item) => (
              <SubmissionCard
