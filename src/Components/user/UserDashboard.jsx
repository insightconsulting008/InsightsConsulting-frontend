...
export default function UserDashboard() {
  ...
  /* ── load all data using same APIs as other pages ── */
  const load = useCallback(async (isRefresh = false) => {
    ...
    if (servicesRes.status === "fulfilled" && servicesRes.value.data?.success) {
      ...
      /* collect all docs needing action from service steps + periods */
      const actionDocs = [];
      list.forEach((ms) => {
    ...
    /* sum document counts from both folders (same pattern as Documents.jsx) */
    let total = 0;
  ...
  /* ── derived stats from services list ── */
  ...
  /* monthly buckets — last 6 months, derived from createdAt */
  const monthlyData = (() => {
    const buckets = {};
    for (let i = 5; i >= 0; i--) {
  ...
  /* services with errors / on hold needing attention */
  ...
  return (
    ...
    >
      ...
      <div className="mb-7 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          <p className="text-[11px] font-bold tracking-widest text-gray-400 uppercase mb-1">{dateStr}</p>
          ...
          <p className="text-sm text-gray-400 mt-1">Here's everything happening with your account today.</p>
        </div>
        <div className="flex items-center gap-2 self-start sm:self-auto">
          <button
            ...
            disabled={refreshing}
            title="Refresh"
            className="p-2.5 bg-white border border-gray-200 rounded-xl text-gray-400 hover:text-gray-700 hover:border-gray-300 transition-all"
          >
      ...
      {!loading && pendingDocs.length > 0 && (
        <div className="mb-5 flex items-center gap-3 px-4 py-3.5 rounded-2xl border-2 border-amber-200 bg-amber-50">
        ...
        <Card className="p-5">
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-6 text-center">
              ...
              <a href="/services" className="text-xs font-bold mt-1 hover:underline" style={{ color: "var(--color-primary)" }}>Browse services →</a>
            </div>
          ) : (
          ...
          {loading ? (
            ...
            <div className="flex-1 overflow-hidden">
              ...
              {(pendingDocs.length + needsAttention.length) > 3 && (
                <a href="/my-services" className="flex items-center justify-center gap-1 mt-3 text-xs font-bold hover:underline" style={{ color: "var(--color-primary)" }}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <Card className="p-5 lg:col-span-2">
          <div className="flex items-center justify-between mb-4">
            ...
            <a href="/my-services" className="text-xs font-bold flex items-center gap-1 hover:underline" style={{ color: "var(--color-primary)" }}>
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-10 text-center">
              ...
              <a href="/services" className="mt-2 text-xs font-bold flex items-center gap-1 hover:underline" style={{ color: "var(--color-primary)" }}>
                ...
                <div className="flex items-center gap-3 mb-3">
                  {profile?.photoUrl ? (
                    ...
                    <div
                      ...
                      style={{ background: "linear-gradient(135deg,var(--color-primary),var(--color-primary-hover))", boxShadow: "0 4px 12px rgb(239 68 68 / .22)" }}
                    >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {profile?.role && (
                      <span className="inline-block text-[10px] font-bold px-2 py-0.5 rounded-full mt-1 capitalize" style={{ background: "var(--primary-50)", color: "var(--color-primary)" }}>
                        {profile.role}
                      </span>
                    )}
                  </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                <a
                  key={href}
                  href={href}
                  className="group flex flex-col gap-1 p-3 rounded-xl border border-gray-100 hover:border-red-100 hover:bg-red-50/30 transition-all duration-150 hover:-translate-y-0.5"
                >
                  <Icon size={15} className="text-gray-400 group-hover:text-primary transition-colors" style={{ '--tw-text-opacity': 1 }} />
