...
const BASE_URL = "https://insightsconsult-backend.onrender.com/api/admin/blogs";
...
export default function AdminBlogList() {
 ...
 const handleDeleteConfirm = async () => {
  ...
  if (loading && allBlogs.length === 0) {
    return (
      <>
        <PageHeader title="Blog Management" subtitle="Manage and organize your blog posts" />
      ...
      <PageHeader
        ...
        actions={
          <button
            ...
            className="inline-flex items-center gap-2 text-white text-sm font-semibold px-4 py-2 rounded-lg transition-colors bg-[var(--color-primary)] hover:bg-[var(--color-primary-hover)]"
          >
                  ...
                  >
                    ...
                    <div className="p-4 flex flex-col flex-1 gap-2.5">
                      ...
                      <div className="grid grid-cols-2 gap-2 pt-3 border-t border-[var(--neutral-200)]">
                        <button
                          onClick={() => navigate(`/manage-blog/${blog.slug}`)}
