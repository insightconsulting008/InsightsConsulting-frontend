...
import {
  ...
  ArrowRight, Briefcase, ShieldCheck, Search,
  CalendarDays, Zap, Ban, PauseCircle,
  CircleCheck, XCircle, Timer, Home,
  FilePen, Bell, LayoutGrid, Inbox,
} from "lucide-react";
...
export default function StaffDashboard() {
  ...
  const [tasks,     setTasks]     = useState([]);    // all applications assigned to this staff
  ...
  /* recent — latest 6 by updatedAt */
  const recentTasks = [...tasks]
    .sort((a, b) => new Date(b.updatedAt ?? b.createdAt) - new Date(a.updatedAt ?? a.createdAt))
    .slice(0, 6);

  /* in-progress tasks with step data for the progress section */
  ...
  return (
    ...
    >
      ...
      <div className="mb-7 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          <p className="text-[11px] font-bold tracking-widest text-gray-400 uppercase mb-1 flex items-center gap-1.5">
            <Home size={11} /> {dateStr}
          </p>
          ...
          <p className="text-sm text-gray-400 mt-1">Here's your task overview for today.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        ...
        {/* in-progress with step progress */}
        <Card className="p-5 flex flex-col">
