...
function UserResetPassword() {
  ...
  // ── Invalid token guard ──
  if (!token) {
    return <InvalidTokenPage redirectTo="/login" redirectLabel="Back to Sign In" icon={UserIcon} />
  }
    ...
    <div className="min-h-screen bg-neutral-50 flex items-center justify-center p-4" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <div className="reset-card w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-neutral-500 mt-2">Choose a strong password for your account</p>
        </div>
